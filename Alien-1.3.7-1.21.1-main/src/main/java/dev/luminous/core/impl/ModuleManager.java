...
public class ModuleManager implements Wrapper {
    ...
    public void render2D(DrawContext drawContext) {
        ...
        modules.stream().filter(Module::isOn).forEach(module -> module.onRender2D(drawContext, Render3DUtil.getTickDelta()));
    }
    public void render3D(MatrixStack matrixStack) {
        ...
        Alien.EVENT_BUS.post(new Render3DEvent(matrixStack, Render3DUtil.getTickDelta()));
        matrixStack.pop();
