...
public class Shader extends Module {
    ...
    public void onRender3D(MatrixStack matrixStack) {
        if (hands.getValue()) {
            Alien.SHADER.renderShader(() -> mc.gameRenderer.renderHand(mc.gameRenderer.getCamera(), Render3DUtil.getTickDelta(), matrixStack.peek().getPositionMatrix()), mode.getValue());
        }
    }
