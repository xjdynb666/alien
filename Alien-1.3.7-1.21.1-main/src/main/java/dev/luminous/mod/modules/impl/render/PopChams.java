...
public class PopChams extends Module {
    ...
    private void renderEntity(MatrixStack matrices, LivingEntity entity, BipedEntityModel<PlayerEntity> modelBase, int alpha) {
        ...
        modelBase.animateModel((PlayerEntity) entity, entity.limbAnimator.getPos(), entity.limbAnimator.getSpeed(), Render3DUtil.getTickDelta());
        ...
        modelBase.render(matrices, buffer, 10, 0, ColorUtil.injectAlpha(color.getValue().getRGB(), alpha));
