...
public class Trajectories extends Module {
    ...
    public void onRender3D(MatrixStack matrixStack) {
        ...
        double x = MathUtil.interpolate(mc.player.prevX, mc.player.getX(), Render3DUtil.getTickDelta());
        double y = MathUtil.interpolate(mc.player.prevY, mc.player.getY(), Render3DUtil.getTickDelta());
        double z = MathUtil.interpolate(mc.player.prevZ, mc.player.getZ(), Render3DUtil.getTickDelta());
        if ((offHand.getItem() instanceof CrossbowItem && InventoryUtil.getEnchantmentLevel(offHand, Enchantments.MULTISHOT) != 0) ||
                (mainHand.getItem() instanceof CrossbowItem && InventoryUtil.getEnchantmentLevel(mainHand, Enchantments.MULTISHOT) != 0)) {
