...
public class Freecam extends Module {
    ...
    public float getFakeYaw() {
        return (float) MathUtil.interpolate(prevFakeYaw, fakeYaw, Render3DUtil.getTickDelta());
    }

    public float getFakePitch() {
        return (float) MathUtil.interpolate(prevFakePitch, fakePitch, Render3DUtil.getTickDelta());
    }

    public double getFakeX() {
        return MathUtil.interpolate(prevFakeX, fakeX, Render3DUtil.getTickDelta());
    }

    public double getFakeY() {
        return MathUtil.interpolate(prevFakeY, fakeY, Render3DUtil.getTickDelta());
    }

    public double getFakeZ() {
        return MathUtil.interpolate(prevFakeZ, fakeZ, Render3DUtil.getTickDelta());
    }
}
