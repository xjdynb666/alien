...
public class Tracers extends Module {
	...
	private void drawLine(Vec3d pos, Color color) {
		Render3DUtil.drawLine(pos, mc.player.getCameraPosVec(Render3DUtil.getTickDelta()).add(Vec3d.fromPolar(mc.player.getPitch(Render3DUtil.getTickDelta()), mc.player.getYaw(Render3DUtil.getTickDelta())).multiply(0.2)), color);
	}
}
