...
public class ChestStealer extends Module {
    ...
    private void update() {
        ...
        this.stealCountList[13] = (int) (this.turtle.getValue() - InventoryUtil.getPotionCount(StatusEffects.RESISTANCE.value()));
    }
    ...
    private boolean needSteal(final ItemStack i) {
        ...
        if (i.getItem() == Items.SPLASH_POTION) {
            var potionContents = i.get(DataComponentTypes.POTION_CONTENTS);
